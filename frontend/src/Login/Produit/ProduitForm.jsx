              ...
              <div style={{ display: 'flex', gap: '1.5rem', width: '100%' }}>
                <div style={{ flex: 1 }}>
                  ...
                  <StyledFormGroup icon={<Package size={18} />} label="Embalage Primaire" htmlFor="produit_Etiq_id">
                    <input
                      id="produit_Etiq_id"
                      name="produit_Etiq_id"
                      value={formData.produit_Etiq_id || ''}
                      onChange={handleChange}
                      style={inputStyle}
                      type="text"
              ...
              <div style={{ display: 'flex', gap: '1.5rem', width: '100%' }}>
                <div style={{ flex: 1 }}>
                  ...
                  <StyledFormGroup icon={<Boxes size={18} />} label="Embalage Secondaire" htmlFor="produit_Embalg_S_id">
                    <input
                      id="produit_Embalg_S_id"
                      name="produit_Embalg_S_id"
                      value={formData.produit_Embalg_S_id || ''}
                      onChange={handleChange}
                      style={inputStyle}
                      type="text"
                      placeholder="Emballage Secondaire"
                      className="form-control styled-input"
                    />
                  </StyledFormGroup>
                </div>
              ...
              <div style={{ display: 'flex', gap: '1.5rem', width: '100%' }}>
                <div style={{ flex: 1 }}>
                  ...
                  <StyledFormGroup icon={<Tag size={18} />} label="Etiquette" htmlFor="produit_Embalg_id">
                    <input
                      id="produit_Embalg_id"
                      name="produit_Embalg_id"
                      value={formData.produit_Embalg_id || ''}
                      onChange={handleChange}
                      style={inputStyle}
                      type="text"
