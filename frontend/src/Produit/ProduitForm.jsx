    ...
    <div>
      ...
      <div
        ...
        style={{
          ...
          transform: formContainerStyle.right === '-100%' ? 'translateX(100%)' : 'translateX(0)',
        }}
      >
        ...
        >
          <Tab eventKey="infoProduit" title={<span><Info className="me-2" size={16} />Informations Produit</span>}>
            <Form className="col row" onSubmit={handleSubmit} style={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
              ...
              <div style={{ display: 'flex', gap: '1.5rem', width: '100%' }}>
                <div style={{ flex: 1 }}>
                  ...
                  <StyledFormGroup icon={<AlertTriangle size={18} />} label="Seuil d'alerte" htmlFor="seuil_alerte">
                    ...
                    />
                    {errors.seuil_alerte && <div className="text-danger" style={{ fontSize: 13 }}>{errors.seuil_alerte}</div>}
                  </StyledFormGroup>
                </div>
                <div style={{ flex: 1 }}>
                  {/* Stock Initial */}
                  <StyledFormGroup icon={<Box size={18} />} label="Stock Initial" htmlFor="stock_initial">
                    ...
                    />
                    {errors.stock_initial && <div className="text-danger" style={{ fontSize: 13 }}>{errors.stock_initial}</div>}
                  </StyledFormGroup>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '1.5rem', width: '100%' }}>
                ...
                <div style={{ flex: 1 }}>
                  {/* Prix Vente */}
                  <StyledFormGroup icon={<DollarSign size={18} />} label="Prix Vente (DH)" htmlFor="prix_vente">
                    <input
                      id="prix_vente"
                      name="prix_vente"
                    ...
                    />
                    {errors.prix_vente && <div className="text-danger" style={{ fontSize: 13 }}>{errors.prix_vente}</div>}
                  </StyledFormGroup>
                </div>
              </div>
            </Form>
          ...
          <Tab eventKey="emballage" title={<span><Package className="me-2" size={16} />Informations Emballage</span>}>
            <Form className="col row" onSubmit={handleSubmit} style={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
              ...
              <div style={{ display: 'flex', gap: '1.5rem', width: '100%' }}>
                <div style={{ flex: 1 }}>
                  {/* Emballage Primaire */}
                  <StyledFormGroup icon={<Package size={18} />} label="Embalage Primaire" htmlFor="emballage_primaire_label">
                    <input
                      id="emballage_primaire_label"
                      name="emballage_primaire_label"
                      value={formData.emballage_primaire_label || ''}
                      onChange={handleChange}
                      style={inputStyle}
                      type="text"
                      placeholder="Emballage Primaire"
              ...
              <div style={{ display: 'flex', gap: '1.5rem', width: '100%' }}>
                <div style={{ flex: 1 }}>
                  ...
                  <StyledFormGroup icon={<Layers size={18} />} label="Embalage Secondaire" htmlFor="emballage_secondaire_label">
                    <input
                      id="emballage_secondaire_label"
                      name="emballage_secondaire_label"
                      value={formData.emballage_secondaire_label || ''}
                      onChange={handleChange}
                      style={inputStyle}
                      type="text"
                      placeholder="Embalage Secondaire"
                      className="form-control styled-input"
                    />
                  </StyledFormGroup>
                </div>
              ...
              <div style={{ display: 'flex', gap: '1.5rem', width: '100%' }}>
                <div style={{ flex: 1 }}>
                  {/* Etiquette */}
                  <StyledFormGroup icon={<Tag size={18} />} label="Etiquette" htmlFor="etiquette_label">
                    <input
                      id="etiquette_label"
                      name="etiquette_label"
                      value={formData.etiquette_label || ''}
                      onChange={handleChange}
                      style={inputStyle}
                      type="text"
          ...
          <Tab eventKey="coutRevient" title={<span><Calculator className="me-2" size={16} />Coût de Revient</span>}>
            <Form className="col row" onSubmit={handleSubmit} style={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
              {/* Row 1: Grammage & Rendement */}
              <div style={{ display: 'flex', gap: '1.5rem', width: '100%' }}>
                <div style={{ flex: 1 }}>
                  <StyledFormGroup icon={<Weight size={18} />} label="Grammage (g)" htmlFor="grammage">
                    <input
                      id="grammage"
                      name="grammage"
                      ...
                      step="0.1"
                      placeholder="0.0"
                      className={`form-control styled-input ${errors.grammage ? 'is-invalid' : ''}`}
                    />
                    {errors.grammage && <div className="text-danger" style={{ fontSize: 13 }}>{errors.grammage}</div>}
                  </StyledFormGroup>
                </div>
                <div style={{ flex: 1 }}>
                  <StyledFormGroup icon={<Activity size={18} />} label="Rendement (%)" htmlFor="rendement">
                    <input
                      id="rendement"
                      name="rendement"
                      value={formData.rendement ?? 100}
                      onChange={handleChange}
                      style={inputStyle}
                      type="number"
                      min="0"
                      ...
                      step="0.1"
                      placeholder="100"
                      className={`form-control styled-input ${errors.rendement ? 'is-invalid' : ''}`}
                    />
                    {errors.rendement && <div className="text-danger" style={{ fontSize: 13 }}>{errors.rendement}</div>}
                  </StyledFormGroup>
                </div>
              </div>
              {/* Row 2: Temps production & Cout horaire MOD */}
              <div style={{ display: 'flex', gap: '1.5rem', width: '100%' }}>
                <div style={{ flex: 1 }}>
                  <StyledFormGroup icon={<Clock size={18} />} label="Temps de production (min)" htmlFor="temps_production">
                    <input
                      id="temps_production"
                      ...
                      step="0.1"
                      placeholder="0.0"
                      className={`form-control styled-input ${errors.temps_production ? 'is-invalid' : ''}`}
                    />
                    {errors.temps_production && <div className="text-danger" style={{ fontSize: 13 }}>{errors.temps_production}</div>}
                  </StyledFormGroup>
                </div>
                <div style={{ flex: 1 }}>
                  <StyledFormGroup icon={<DollarSign size={18} />} label="Coût horaire MOD (DH/h)" htmlFor="cout_horaire_mod">
                    <input
                      id="cout_horaire_mod"
                      ...
                      step="0.01"
                      placeholder="0.00"
                      className={`form-control styled-input ${errors.cout_horaire_mod ? 'is-invalid' : ''}`}
                    />
                    {errors.cout_horaire_mod && <div className="text-danger" style={{ fontSize: 13 }}>{errors.cout_horaire_mod}</div>}
                  </StyledFormGroup>
                </div>
              </div>
              {/* Row 3: Quantite mensuelle & Temps machine */}
              <div style={{ display: 'flex', gap: '1.5rem', width: '100%' }}>
                <div style={{ flex: 1 }}>
                  <StyledFormGroup icon={<Box size={18} />} label="Quantité produite / mois" htmlFor="quantite_production_mensuelle">
                    <input
                      id="quantite_production_mensuelle"
                      name="quantite_production_mensuelle"
                      value={formData.quantite_production_mensuelle}
                      onChange={handleChange}
                      style={inputStyle}
                      type="number"
                      min="0"
                      ...
                      step="1"
                      placeholder="0"
                      className={`form-control styled-input ${errors.quantite_production_mensuelle ? 'is-invalid' : ''}`}
                    />
                    {errors.quantite_production_mensuelle && <div className="text-danger" style={{ fontSize: 13 }}>{errors.quantite_production_mensuelle}</div>}
                  </StyledFormGroup>
                </div>
                <div style={{ flex: 1 }}>
                  <StyledFormGroup icon={<Clock size={18} />} label="Temps machine (min)" htmlFor="temps_machine">
                    <input
                      id="temps_machine"
                      name="temps_machine"
                      value={formData.temps_machine}
                      onChange={handleChange}
                      style={inputStyle}
                      type="number"
                      min="0"
                      ...
                      step="0.1"
                      placeholder="0.0"
                      className={`form-control styled-input ${errors.temps_machine ? 'is-invalid' : ''}`}
                    />
                    {errors.temps_machine && <div className="text-danger" style={{ fontSize: 13 }}>{errors.temps_machine}</div>}
                  </StyledFormGroup>
                </div>
              </div>
            </Form>
        ...
        {/* Boutons Valider/Annuler - toujours visibles */}
        <div style={{
          position: 'sticky',
          bottom: 0,
          background: '#fff',
          ...
          <Button type="button" className="btn-primary-custom" onClick={handleSubmit}>Valider</Button>
          <Button type="button" className="btn-secondary-custom" onClick={closeForm}>Annuler</Button>
        </div>
