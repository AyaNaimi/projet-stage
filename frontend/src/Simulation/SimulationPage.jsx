...
const SimulationPage = () => {
  ...
  useEffect(() => {
    // minimal=1 déclenche la requête légère dans ProduitController::index
    // (SELECT id, designation, Code_produit... sans relations ni unit_cost)
    axiosInstance.get("/api/produits", { params: { minimal: 1 } })
      .then((res) => {
