...
const ProduitList = () => {
  ...
  const [calibresLoading, setCalibresLoading] = useState(false);
...
const [genreFiltre, setGenreFiltre] = useState("");
  ...
  const { sortedData, handleSort,setSortedData ,sortColumn,sortOrder} = useSortableData(produitsFiltres);
...
style={{marginLeft:'120px',marginTop:'-30px',marginBottom:'-21px'}}
>
<h5 className="container-d-flex justify-content-start titreColore"style={{marginLeft:'-120px',marginTop:'20px'}} >
Famille Produit</h5>
<h5 className="container-d-flex justify-content-start titreColore"style={{marginRight:'50%',marginTop:'20px'}} >
Type</h5>
</div>

          <div className="d-flex justify-content-between" style={{marginTop:'20px'}}>
  <div className="container bgCategories" style={{marginLeft:'0px'}}>
    <Carousel activeIndex={activeIndex} onSelect={handleSelect} interval={null}
     nextIcon={<FaArrowRight size="2x" color="@ffffff" style={{backgroundColor:"black" ,borderRadius:'50%' ,marginTop:'-35px',marginLeft:'0px',marginRight:'-10px'}} />}
     prevIcon={<FaArrowLeft size="2x" color="@ffffff" style={{backgroundColor:"black" ,borderRadius:'50%',marginTop:'-35px',marginLeft:'-10px'}} />}>

      {chunks.map((chunk, chunkIndex) => (
        <Carousel.Item key={chunkIndex}>
          <div className="d-flex justify-content-start">
            <a href="#" style={{marginLeft:'40px',marginTop:'5px' , marginBottom:'5px'}}>
              <div
            ...
            {chunk.map((category, index) => (
              <a href="#"  key={index} style={{marginTop:'5px' , marginBottom:'5px',marginLeft:'80px'}}>
                <div 
                ...
                >
                  ...
                  />
                  <p className="category-text">{category.categorie}</p>
                </div>
              </a>
            ))}
          </div>
  ...
  <div className="container bgCategories" style={{marginRight:'0'}}>
    <Carousel
  ...
  {chunksSucat.map((chunk, chunkIndex) => (
    <Carousel.Item key={chunkIndex}>
      <div className="d-flex justify-content-start">
        <a href="#" style={{marginLeft:'40px',marginBottom:'3px'}}>
          <div
        ...
        {chunk.map((category, index) => (
          <a href="#" className="mx-5" key={index}>
            <div
              ...
              onClick={() => handleSousCategoryFilterChange(category.id)}
            >
              <img
                src={category.logoP}
                alt={category.categorie}
          ...
          <div className="container-d-flex justify-content-start">
            ...
            >
              ...
              <ListItemIcon style={{position:'absolute',left:'25px',fontSize:'20px'}} >
            ...
            <div style={{ marginTop: "-25px",}}>
              ...
              <div
                ...
                className=""
                style={{...formContainerStyle,marginTop:'-10px',height: `calc(100vh - 300px)`,overflow:'auto' }}
              >
                {
                  chart ? <CategoryProductChart chartData={chartData}/>:
            ...
            {allColumns.map((column) => (
              <label key={column.key} className="dropdown-item">
                <input
                  ...
                  onClick={() => toggleColumnVisibility(column.key)} // Toggle column visibility
                />
                {column.label}
              </label>
            ))}
...
<thead className="text-center" style={{ position: 'sticky', top: -1, backgroundColor: '#ddd', zIndex: 1, padding: '0px' }}>
  <tr style={{ width: '50px' }}>
    ...
    {columnVisibility.code && (
      <th className="tableHead">
        Code
        <SortableColumn column="Code_produit" sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort} />
      </th>
    )}
    {columnVisibility.designation && (
      <th className="tableHead">
        Désignation
        <SortableColumn column="designation" sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort} />
      </th>
    )}
    {columnVisibility.typeQuantite && (
      <th className="tableHead">
        Type de Quantité
        <SortableColumn column="type_quantite" sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort} />
      </th>
    )}
    {columnVisibility.typeQuantite && (
      <th className="tableHead">
        Type de Produit
        <SortableColumn column="type" sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort} />
      </th>
    )}
    {columnVisibility.marque && (
      <th className="tableHead">
        Marque
        <SortableColumn column="marque" sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort} />
      </th>
    )}
    {columnVisibility.unite && (
      <th className="tableHead">
        Unité
        <SortableColumn column="unite" sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort} />
      </th>
    )}
    {columnVisibility.seuilAlerte && (
      <th className="tableHead">
        Seuil d'alerte
        <SortableColumn column="seuil_alerte" sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort} />
      </th>
    )}
    {columnVisibility.stockInitial && (
      <th className="tableHead">
        Stock initial
        <SortableColumn column="stock_initial" sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort} />
      </th>
    )}
    {columnVisibility.etatProduit && (
      <th className="tableHead">
        État de produit
        <SortableColumn column="etat_produit" sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort} />
      </th>
    )}
    {columnVisibility.calibre && (
      <th className="tableHead">
        Calibre
        <SortableColumn column="calibre.calibre" bool={true} sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort} />
      </th>
    )}
    {columnVisibility.prixVente && (
      <th className="tableHead">
        Prix vente
        <SortableColumn column="prix_produits_last.prixProduit" bool={true} sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort} />
      </th>
    )}
    {columnVisibility.tva && (
      <th className="tableHead">
        TVA
        <SortableColumn column="tva" sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort} />
      </th>
    )}
    {columnVisibility.famille && (
      <th className="tableHead">
        Famille
        <SortableColumn column="categorie.categorie" sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort}  bool={true} />
      </th>
    )}
    {columnVisibility.type && (
      <th className="tableHead">
        Type
        <SortableColumn column="souscategorie.categorie" bool={true} sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort} />
      </th>
    )}
    {columnVisibility.type && (
      <th className="tableHead">
        Durée de vie
        <SortableColumn column="Dvie" sortColumn={sortColumn} sortOrder={sortOrder} onSort={handleSort}/>
      </th>
    )}
              ...
              .map((produit) => (
                <React.Fragment key={produit.id}>
                  <tr key={produit.id}>
                    ...
                    {columnVisibility.typeQuantite && <td style={{ backgroundColor: "white" }}>{produit.type==='P'?'Production':produit.type==='M'?'MATIERE PREMIERE':''}</td>}

                    {columnVisibility.marque && <td style={{ backgroundColor: "white" }}>{produit.marque || ''}</td>}
                    {columnVisibility.unite && <td style={{ backgroundColor: "white" }}>{produit.unite || ''}</td>}
                    {columnVisibility.seuilAlerte && <td style={{ backgroundColor: "white" }}>{produit.seuil_alerte || ''}</td>}
                    {columnVisibility.stockInitial && <td style={{ backgroundColor: "white" }}>{produit.stock_initial || ''}</td>}
                    {columnVisibility.etatProduit && <td style={{ backgroundColor: "white" }}>{produit.etat_produit || ''}</td>}
                    {columnVisibility.calibre && <td style={{ backgroundColor: "white" }}>{produit.calibre ? produit.calibre.calibre : ''}</td>}
                    {columnVisibility.prixVente && <td>   {produit?.prix_produits_last?.prixProduit}
  {produit?.prix_produits?.length>0&&
     <FontAwesomeIcon
                onClick={() => toggleRowRepresantant(produit.id)} // Ajout de la fonction d'expansion
                icon={expandedRowsRepresantant.includes(produit.id) ? faList : faList}
                style={{ marginLeft: "10px", cursor: "pointer" }}
              />
  }</td>}
    {columnVisibility.tva && <td style={{ backgroundColor: "white" }}>{produit.tva || ''}</td>}
                    {columnVisibility.famille && <td style={{ backgroundColor: "white" }}>{produit?.categorie?.categorie || ''}</td>}
                    {columnVisibility.type && <td style={{ backgroundColor: "white" }}>{produit?.souscategorie?.categorie || ''}</td>}
                    {columnVisibility.type && <td style={{ backgroundColor: "white" }}>{produit?.Dvie || ''}</td>}
                    {columnVisibility.action && (
  <td className="sticky-action-column" style={{ backgroundColor: "white" }}>
    {/* Vérification de la permission pour l'édition */}
    <FontAwesomeIcon 
      onClick={permissions.includes("edit_product") ? () => handleEdit(produit, false) : null} 
      icon={faEdit} 
      style={{ 
        color: permissions.includes("edit_product") ? "#007bff" : "#b0bec5", 
        cursor: permissions.includes("edit_product") ? "pointer" : "not-allowed" 
      }} 
    />
    ...
    <FontAwesomeIcon 
      onClick={permissions.includes("delete_product") ? () => handleDelete(produit.id) : null} 
      icon={faTrash} 
      style={{ 
        color: permissions.includes("delete_product") ? "#ff0000" : "#b0bec5", 
        cursor: permissions.includes("delete_product") ? "pointer" : "not-allowed" 
      }} 
    />
  </td>
)}
                  ...
                  {expandedRowsRepresantant.includes(produit.id) && (
                    <tr>
                      <td colSpan="25" style={{ padding: "0" }}>
                        <table className="table table-responsive table-bordered" style={{ marginTop: '0px', marginBottom: '0px' }}>
                          <thead>
                            <tr>
