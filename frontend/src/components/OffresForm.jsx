...
function OffresForm({
  ...
  handleChange,
  handleSubmit,
  handleOffre_detailChange,
  handleAddOffre_detail,
  handleRemoveOffre_detail,
  editing,
  setShowForm,
}) {
  const offreDetailsArray = Array.isArray(form.Offre_details)
    ? form.Offre_details
    : [];
  ...
  return (
    <div className="offres-form">
      ...
      <form onSubmit={handleSubmit}>
              ...
              <tr key={index}>
                <td style={{ backgroundColor: "white" }}>
                  <Select
                    ...
                    onChange={(selected) =>
                      handleProductSelection(selected, index)
                    }
                    values={
                      Offre_detail.produit_id
                        ? [
                            {
                              value: Offre_detail.produit_id,
                              label: produits.find(
                                (p) => p.id === Offre_detail.produit_id,
                              )?.Code_produit,
                            },
                          ]
                        : []
                ...
                <td>
                  <Select
                    ...
                    onChange={(selected) =>
                      handleDesignationSelection(selected, index)
                    }
                    values={
                      Offre_detail.produit_id
                        ? [
                ...
                <td>
                  <input
                    ...
                    onChange={(e) =>
                      handleOffre_detailChange(index, "Prix", e.target.value)
                    }
                ...
                <td>
                  <button
                    ...
                    onClick={() => handleRemoveOffre_detail(index)}
                  >
        ...
        <button type="submit" className="btn btn-primary text-center m-2">
