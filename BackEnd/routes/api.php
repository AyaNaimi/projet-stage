...
Route::apiResource('groupe-arrondi', GroupeArrondiController::class);
     ...
     // ── CostEngine — doit être AVANT les routes paramétrées {produit} ─────
    ...
    // Mise à jour partielle charges directes (MOD uniquement — pas de validation designation/code)
    Route::patch('produits/{id}/charges-directes', [ProduitController::class, 'updateChargesDirectes']);
