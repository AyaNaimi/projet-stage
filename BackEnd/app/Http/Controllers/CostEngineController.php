...
class CostEngineController extends Controller
{
    ...
    {
        try {
            // Aligner la valeur par défaut sur le frontend (10 lignes par page)
            ...
            // ── Optimisation : pré-charger les charges indirectes et les bases
            //    globales UNE SEULE FOIS pour éviter N requêtes BD dans la boucle
            ...
            // Libérer le cache en mémoire après la boucle
