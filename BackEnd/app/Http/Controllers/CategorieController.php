...
class CategorieController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            // Sanitize idCatMer: FormData sends null/undefined as a string
            $rawIdCatMer = $request->input('idCatMer');
            $category->idCatMer = (is_null($rawIdCatMer) || $rawIdCatMer === '' || $rawIdCatMer === 'null' || $rawIdCatMer === 'undefined')
                ? null
                : (int) $rawIdCatMer;
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            // Sanitize idCatMer: FormData sends null/undefined as a string
            $rawIdCatMer = $request->input('idCatMer');
            $categorie->idCatMer = (is_null($rawIdCatMer) || $rawIdCatMer === '' || $rawIdCatMer === 'null' || $rawIdCatMer === 'undefined')
                ? null
                : (int) $rawIdCatMer;
