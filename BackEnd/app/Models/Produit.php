...
class Produit extends Model
{
    ...
    protected $fillable = [
        ...
        'temps_machine',
        // Libellés texte libre pour l'emballage (remplacent les FK dans le formulaire)
...
public function stockProduit()
{
    ...
    // unit_cost est volontairement exclu des appends globaux : son calcul
    // appelle le CostEngineService (ChargeIndirecte::all() + 3 requêtes agrégées)
    // pour chaque produit sérialisé, ce qui rendait /api/produits très lent.
    // Le coût unitaire est exposé via les endpoints dédiés :
    //   GET /api/produits/{id}/cout-unitaire
    //   GET /api/cout-produits  (tableau de bord paginé, optimisé avec preload)
